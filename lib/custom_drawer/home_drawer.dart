...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndex.SchoolMap,
        labelName: 'School Map',
        icon: Icon(Icons.map),
      ),
      DrawerList(
        index: DrawerIndex.RectoratePage,
        labelName: 'Rectorate',
        isAssetsImage: true,
        imageName: 'assets/images/rector.png',
      ),
      DrawerList(
        index: DrawerIndex.Engineering,
        labelName: 'Engineering Faculty',
        isAssetsImage: true,
      ...
      DrawerList(
        ...
        labelName: 'Food Court',
        isAssetsImage: true,
        imageName: 'assets/images/restaurant.png',
      ),
      DrawerList(
        index: DrawerIndex.Help,
        labelName: 'Mosque',
        isAssetsImage: true,
        imageName: 'assets/images/cami.png',
      ),
      DrawerList(
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset('assets/images/kbu_logo.png'),
                            ),
                          ),
                        ),
                      );
